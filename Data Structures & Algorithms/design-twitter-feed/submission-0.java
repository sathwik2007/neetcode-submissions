class Twitter {
    ...
    public List<Integer> getNewsFeed(int userId) {
        //List to store the 10 most recent tweets
        List<Integer> res = new ArrayList<>();
        //Min heap to store the tweets along with their time of insertion
        PriorityQueue<int[]> minHeap = new PriorityQueue<>((a, b) -> Integer.compare(a[0], b[0]));
        //Adding the user to his own followers list to retrieve his tweets
